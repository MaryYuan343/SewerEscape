...
public class Menu extends State implements StateMethods {
    ...
    private void loadButtons() {
        ...
        buttons[2] = new MenuButton(Game.GAME_WIDTH / 2, (int) (270 * Game.SCALE), 4, Gamestate.TUTORIAL);
        ...
        for (MenuButton mb : buttons) {
            if (isIn(e, mb)) {
                if (mb.isMousePressed())
                    mb.applyGamestate();
                if (mb.getState() == Gamestate.PLAYING || mb.getState() == Gamestate.TUTORIAL) {
                    game.getAudioPlayer()
                            .setLevelSong(game.getPlaying().getLevelManager().getLevelIndex());
                }
                break;
            }
        }
