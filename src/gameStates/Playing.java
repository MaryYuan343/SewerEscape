...
public class Playing extends State implements StateMethods {
    ...
    public void gameCompletedReset(){
        player.setSpawn(levelManager.getFirstLevelPos());
    }
    ...
    public void checkKeyTouched(Player p){
        objectManager.checkKeyTouched(p, xLvlOffset);
    }

    public void checkDoorTouched(Key key){
        objectManager.checkDoorTouched(key);
    }
