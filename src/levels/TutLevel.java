...
public class TutLevel {
    ...
    public TutLevel(BufferedImage img) {
        this.img = img;
        lvlData = new int[img.getHeight()][img.getWidth()];
//        key = new Key(350, 350, KEY);
//        door = new Door(500, 350, DOOR);
        loadLevel();
        calcLvlOffsets();
    }
    ...
    private void loadObjects(int blueValue, int x, int y) {
        switch (blueValue) {
            ...
            case KEY -> key = new Key(x * Game.TILES_SIZE, y * Game.TILES_SIZE - 38, blueValue);
            case DOOR -> door = new Door(x * Game.TILES_SIZE, y * Game.TILES_SIZE, blueValue);
        }
    }
