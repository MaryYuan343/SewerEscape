...
public class Constants {
    ...
    public static class ObjectConstants {
        ...
        public static final int KEY_WIDTH_DEFAULT = 30;
        public static final int KEY_HEIGHT_DEFAULT = 30;
        public static final int KEY_WIDTH = (int) (Game.SCALE * KEY_WIDTH_DEFAULT * 0.8f);
        public static final int KEY_HEIGHT = (int) (Game.SCALE * KEY_HEIGHT_DEFAULT * 0.8f);
        public static final int KEY_TRAIL_X = (int)(20 * Game.SCALE);

        public static final int DOOR_WIDTH_DEFAULT = 32;
        public static final int DOOR_HEIGHT_DEFAULT = 32;
