...
public class MouseInputs implements MouseListener, MouseMotionListener {
    ...
    public void mouseDragged(MouseEvent e) {
        switch (Gamestate.state) {
            ...
            case TUTORIAL -> gamePanel.getGame().getTutorial().mouseDragged(e);
    ...
    public void mouseMoved(MouseEvent e) {
        switch (Gamestate.state) {
            ...
            case TUTORIAL -> gamePanel.getGame().getTutorial().mouseMoved(e);
    ...
    public void mouseClicked(MouseEvent e) {
        switch (Gamestate.state) {
            ...
            case TUTORIAL -> gamePanel.getGame().getTutorial().mouseClicked(e);
        }
    }
    ...
    public void mousePressed(MouseEvent e) {
        switch (Gamestate.state) {
            ...
            case TUTORIAL -> gamePanel.getGame().getTutorial().mousePressed(e);
    ...
    public void mouseReleased(MouseEvent e) {
        switch (Gamestate.state) {
            ...
            case TUTORIAL -> gamePanel.getGame().getTutorial().mouseReleased(e);
