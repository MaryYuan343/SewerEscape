...
public class Player extends Entity {
    ...
    private void checkKeyTouched(){
        playing.checkKeyTouched(this);
    }

    private void checkDoorTouched(){
        playing.checkDoorTouched(playing.getLevelManager().getCurrentLevel().getKey());
    }
...
//		drawAttackBox(g, lvlOffset);
    ...
    public void resetAll() {
        ...
        if(playing.isGameOver() || playing.isGameCompleted()) {
